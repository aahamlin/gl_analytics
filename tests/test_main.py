...
from gl_analytics.issues import GITLAB_URL_BASE, GitlabSession, GitlabIssuesRepository, GitlabWorkflowResolver, Issue

from . import build_fake_http_response, FakeRequestFactory
...
def test_main(requests_mock):
    ...
    """
    requests_mock.get(GITLAB_URL_BASE + '/groups/gozynta/issues',
                      body=io.BytesIO(b'[{"id":8000234,"iid":2,"project_id":"8273019","title":"test title","created_at":"2021-03-09T17:59:43.041Z"}]'))
    requests_mock.get(GITLAB_URL_BASE + '/projects/8273019/issues/2/resource_label_events',
